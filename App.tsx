...
const App: React.FC = () => {
  ...
  const handleQuizComplete = async (answers: Record<number, string>, cosmicDetails: CosmicDetails) => {
    ...
    try {
      ...
      console.error(error);
      setErrorMsg("The spirits are silent. Please check your connection or API key.");
    ...
    <div className="min-h-screen bg-black text-white selection:bg-rose-900 selection:text-white">
      ...
      {stage === AppStage.ERROR && (
        <div className="flex flex-col items-center justify-center min-h-screen text-center p-8">
          <h2 className="text-2xl font-display text-rose-500 mb-4">Analysis Failed</h2>
